...
Last dashboard update: Jun 15, 2026, 09:39 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 2420 active latest cluster reports. 4 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 2420 | 100% |
| Policy-archived clusters | 4 | audit |
| Clean completed clusters | 1818 | 75.1% |
| Needs-human clusters | 416 | 17.2% |
| Latest successful clusters | 2349 | 97.1% |
| Latest failed clusters | 2 | 0.1% |
| Latest cancelled clusters | 1 | 0.0% |
| Run attempts archived | 3330 | audit |
| Fix action attempts | 254 | audit |
| Fix actions executed | 1 | 0.4% |
| Fix actions failed | 61 | 24.0% |
| Fix actions blocked | 80 | 31.5% |
| Latest clusters with fix failures | 64 | 2.6% |
| Distinct PRs touched | 6238 | 100% |
| Open PRs tracked | 2937 | 47.1% |
| Closed unmerged PRs tracked | 2687 | 43.1% |
| Completed close actions | 35 | 9.0% |
| Completed merge actions | 26 | 6.7% |
| Duplicate closes | 24 | 68.6% |
| Superseded closes | 1 | 2.9% |
| Fixed-by-candidate closes | 0 | 0.0% |
| Low-signal PR closes | 0 | 0.0% |
| Blocked mutation attempts | 192 | 49.6% |
| Skipped mutation attempts | 134 | 34.6% |

### Clusters Needing Inspection

| Cluster | State | Source job | Reason | Report | Run |
| --- | --- | --- | --- | --- | --- |
| [pr-inventory-needs_proof-20260615T085227-045](results/openclaw/pr-inventory-needs_proof-20260615t085227-045.md) | needs human | jobs/openclaw/inbox/pr-inventory-needs_proof-20260615T085227-045.md | #56785 requires refreshed hydration before classification. | [report](results/openclaw/pr-inventory-needs_proof-20260615t085227-045.md) | 178151585733 |
| [pr-inventory-mixed-20260615T085227-044](results/openclaw/pr-inventory-mixed-20260615t085227-044.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-044.md | Re-run or refresh the cluster preflight hydration after GitHub API rate limiting clears; every candidate has unavailable live state and n... | [report](results/openclaw/pr-inventory-mixed-20260615t085227-044.md) | 178151585732 |
| [pr-inventory-mixed-20260615T085227-043](results/openclaw/pr-inventory-mixed-20260615t085227-043.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-043.md | Re-run hydration for all 25 refs after GitHub API rate limit clears, then classify each PR independently using fresh live state and targe... | [report](results/openclaw/pr-inventory-mixed-20260615t085227-043.md) | 178151585731 |
| [pr-inventory-mixed-20260615T085227-042](results/openclaw/pr-inventory-mixed-20260615t085227-042.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-042.md | Refresh live GitHub hydration for all 25 refs after the GitHub API rate limit clears; the current preflight artifact has no usable live s... | [report](results/openclaw/pr-inventory-mixed-20260615t085227-042.md) | 178151585730 |
| [pr-inventory-mixed-20260615T085227-041](results/openclaw/pr-inventory-mixed-20260615t085227-041.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-041.md | Re-run hydration for all 25 refs after GitHub API rate limit clears; this artifact has no live target kind, state, updated_at, comments, ... | [report](results/openclaw/pr-inventory-mixed-20260615t085227-041.md) | 178151585729 |
| [pr-inventory-mixed-20260615T085227-040](results/openclaw/pr-inventory-mixed-20260615t085227-040.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-040.md | Re-run this shard after GitHub API rate limit recovery so each PR has hydrated kind, state, updated_at, comments/review comments, checks,... | [report](results/openclaw/pr-inventory-mixed-20260615t085227-040.md) | 178151585728 |
| [pr-inventory-mixed-20260615T085227-039](results/openclaw/pr-inventory-mixed-20260615t085227-039.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-039.md | #86959: refresh hydration after GitHub API rate limit resets; live kind/state/updated_at/comments/review data are unavailable. | [report](results/openclaw/pr-inventory-mixed-20260615t085227-039.md) | 178151585727 |
| [pr-inventory-mixed-20260615T085227-038](results/openclaw/pr-inventory-mixed-20260615t085227-038.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-038.md | Re-run cluster hydration for all 25 refs after GitHub API rate limit recovers; current artifact has null updated_at and unavailable live ... | [report](results/openclaw/pr-inventory-mixed-20260615t085227-038.md) | 178151585726 |
| [pr-inventory-mixed-20260615T085227-037](results/openclaw/pr-inventory-mixed-20260615t085227-037.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-037.md | Refresh the cluster after GitHub API rate limit recovery so each PR has live kind, state, updated_at, comments, review comments, checks, ... | [report](results/openclaw/pr-inventory-mixed-20260615t085227-037.md) | 178151585725 |
| [pr-inventory-mixed-20260615T085227-036](results/openclaw/pr-inventory-mixed-20260615t085227-036.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-036.md | Re-run hydration for #86335 after GitHub API rate limit clears; current artifact has no live state, PR kind, target_updated_at, comments,... | [report](results/openclaw/pr-inventory-mixed-20260615t085227-036.md) | 178151585724 |
| [pr-inventory-mixed-20260615T085227-035](results/openclaw/pr-inventory-mixed-20260615t085227-035.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-035.md | Hydration unavailable for #90709 due GitHub API rate limit in preflight artifact; rerun with fresh GitHub state before classifying or mut... | [report](results/openclaw/pr-inventory-mixed-20260615t085227-035.md) | 178151585723 |
| [pr-inventory-mixed-20260615T085227-034](results/openclaw/pr-inventory-mixed-20260615t085227-034.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-034.md | Rehydrate unavailable candidate PRs after GitHub API rate limit clears before classifying or planning any mutation: #80788, #70596, #7502... | [report](results/openclaw/pr-inventory-mixed-20260615t085227-034.md) | 178151585722 |
| [pr-inventory-mixed-20260615T085227-033](results/openclaw/pr-inventory-mixed-20260615t085227-033.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-033.md | Refetch live GitHub state for #91346; preflight artifact has kind unknown, state unavailable, updated_at null due API rate limit. | [report](results/openclaw/pr-inventory-mixed-20260615t085227-033.md) | 178151585721 |
| [pr-inventory-mixed-20260615T085227-032](results/openclaw/pr-inventory-mixed-20260615t085227-032.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-032.md | #91222 requires maintainer/proof judgment because Real behavior proof failed and ClawSweeper says live Vertex evidence is missing. | [report](results/openclaw/pr-inventory-mixed-20260615t085227-032.md) | 178151585720 |
| [pr-inventory-mixed-20260615T085227-031](results/openclaw/pr-inventory-mixed-20260615t085227-031.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-031.md | #68677: maintainer review is explicitly required before any merge recommendation despite proof passing. | [report](results/openclaw/pr-inventory-mixed-20260615t085227-031.md) | 178151585719 |
| [pr-inventory-mixed-20260615T085227-030](results/openclaw/pr-inventory-mixed-20260615t085227-030.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-030.md | #70348 requires fresh hydration before classification. | [report](results/openclaw/pr-inventory-mixed-20260615t085227-030.md) | 178151585718 |
| [pr-inventory-mixed-20260615T085227-029](results/openclaw/pr-inventory-mixed-20260615t085227-029.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-029.md | Refresh hydration for unavailable listed candidates before classification: #68455, #66071, #69297, #69346, #69806, #69059, #68503, #69022... | [report](results/openclaw/pr-inventory-mixed-20260615t085227-029.md) | 178151585717 |
| [pr-inventory-mixed-20260615T085227-027](results/openclaw/pr-inventory-mixed-20260615t085227-027.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-027.md | #90750 missing hydrated preflight state and target_updated_at in compacted artifact. | [report](results/openclaw/pr-inventory-mixed-20260615t085227-027.md) | 178151585715 |
| [pr-inventory-mixed-20260615T085227-026](results/openclaw/pr-inventory-mixed-20260615t085227-026.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-026.md | #64703 requires maintainer judgment on whether unquoted scientific notation should be coerced to number by parseConfigValue. | [report](results/openclaw/pr-inventory-mixed-20260615t085227-026.md) | 178151585714 |
| [pr-inventory-mixed-20260615T085227-025](results/openclaw/pr-inventory-mixed-20260615t085227-025.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-025.md | #83991: maintainer technical judgment needed on Google Vertex/Gemini CLI proof sufficiency. | [report](results/openclaw/pr-inventory-mixed-20260615t085227-025.md) | 178151585713 |
| [pr-inventory-mixed-20260615T085227-016](results/openclaw/pr-inventory-mixed-20260615t085227-016.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-016.md | #89098: ClawSweeper found issues before merge on a maintainer draft PR. | [report](results/openclaw/pr-inventory-mixed-20260615t085227-016.md) | 178151585704 |
| [pr-inventory-mixed-20260615T085227-014](results/openclaw/pr-inventory-mixed-20260615t085227-014.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-014.md | #88491: maintainer-owned PR with missing hydrated live item details; requires maintainer review rather than automated inventory action. | [report](results/openclaw/pr-inventory-mixed-20260615t085227-014.md) | 178151585702 |
| [pr-inventory-mixed-20260615T085227-013](results/openclaw/pr-inventory-mixed-20260615t085227-013.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260615T085227-013.md | #77232 missing hydrated live state in compacted artifact. | [report](results/openclaw/pr-inventory-mixed-20260615t085227-013.md) | 178151585701 |
...
| --- | ---: | --- |
| target changed since worker review | 33 | [gitcrawl-283-close-canary-20260615-b](results/openclaw/gitcrawl-283-close-canary-20260615-b.md) |
