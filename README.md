...
Last dashboard update: Jun 15, 2026, 00:20 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 413 active latest cluster reports. 4 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 413 | 100% |
| Policy-archived clusters | 4 | audit |
| Clean completed clusters | 220 | 53.3% |
| Needs-human clusters | 51 | 12.3% |
| Latest successful clusters | 404 | 97.8% |
...
| Latest clusters with fix failures | 71 | 17.2% |
| Distinct PRs touched | 1248 | 100% |
| Open PRs tracked | 99 | 7.9% |
| Closed unmerged PRs tracked | 956 | 76.6% |
