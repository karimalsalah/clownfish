...
Last dashboard update: Jun 15, 2026, 01:42 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 428 active latest cluster reports. 4 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 428 | 100% |
| Policy-archived clusters | 4 | audit |
| Clean completed clusters | 232 | 54.2% |
| Needs-human clusters | 54 | 12.6% |
| Latest successful clusters | 419 | 97.9% |
| Latest failed clusters | 3 | 0.7% |
| Latest cancelled clusters | 1 | 0.2% |
| Run attempts archived | 754 | audit |
...
| Distinct PRs touched | 1285 | 100% |
| Open PRs tracked | 120 | 9.3% |
| Closed unmerged PRs tracked | 963 | 74.9% |
