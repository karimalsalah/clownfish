...
Last dashboard update: Jun 16, 2026, 01:50 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 3619 active latest cluster reports. 4 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 3619 | 100% |
| Policy-archived clusters | 4 | audit |
| Clean completed clusters | 2328 | 64.3% |
| Needs-human clusters | 1030 | 28.5% |
| Latest successful clusters | 3460 | 95.6% |
| Latest failed clusters | 102 | 2.8% |
| Latest cancelled clusters | 3 | 0.1% |
| Run attempts archived | 4636 | audit |
...
| Distinct PRs touched | 6686 | 100% |
| Open PRs tracked | 2957 | 44.2% |
| Closed unmerged PRs tracked | 2991 | 44.7% |
...
| [pr-inventory-mixed-20260616T013940-005](results/openclaw/pr-inventory-mixed-20260616t013940-005.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260616T013940-005.md | #88292: maintainer-owned draft availability-sensitive Windows update path needs maintainer review. | [report](results/openclaw/pr-inventory-mixed-20260616t013940-005.md) | [27588298361](https://github.com/openclaw/clownfish/actions/runs/27588298361) |
...
| [pr-inventory-mixed-20260616T013940-002](results/openclaw/pr-inventory-mixed-20260616t013940-002.md) | needs human | jobs/openclaw/inbox/pr-inventory-mixed-20260616T013940-002.md | #88479 requires maintainer/product and technical review judgment because it is an active XL UI PR with recent author follow-up, unresolve... | [report](results/openclaw/pr-inventory-mixed-20260616t013940-002.md) | [27588297920](https://github.com/openclaw/clownfish/actions/runs/27588297920) |
| [gitcrawl-520-dedupe-only-20260429-remote](results/openclaw/gitcrawl-520-dedupe-only-20260429-remote.md) | workflow failure | jobs/openclaw/inbox/gitcrawl-520-dedupe-only-20260429-remote.md | Canonical remains the open issue #39476. The duplicate candidate #62872 is already closed, so no close action is valid. #44309 remains re... | [report](results/openclaw/gitcrawl-520-dedupe-only-20260429-remote.md) | [27586169767](https://github.com/openclaw/clownfish/actions/runs/27586169767) |
| [gitcrawl-17426-autonomous-smoke](results/openclaw/gitcrawl-17426-autonomous-smoke.md) | needs human | jobs/openclaw/inbox/gitcrawl-17426-autonomous-smoke.md | Regenerate or rehydrate gitcrawl cluster 17426: the job describes a clawhub login Unauthorized cluster with open candidates, but live pre... | [report](results/openclaw/gitcrawl-17426-autonomous-smoke.md) | [27586103415](https://github.com/openclaw/clownfish/actions/runs/27586103415) |
| [gitcrawl-17439-autonomous-smoke](results/openclaw/gitcrawl-17439-autonomous-smoke.md) | needs human | jobs/openclaw/inbox/gitcrawl-17439-autonomous-smoke.md | Refresh or discard cluster gitcrawl-17439-autonomous-smoke: the hinted canonical #1254 is unavailable, and the hydrated refs #1863/#1256/... | [report](results/openclaw/gitcrawl-17439-autonomous-smoke.md) | [27586103690](https://github.com/openclaw/clownfish/actions/runs/27586103690) |
| [gitcrawl-14088-dedupe-only-20260429-remote](results/openclaw/gitcrawl-14088-dedupe-only-20260429-remote.md) | needs human | jobs/openclaw/inbox/gitcrawl-14088-dedupe-only-20260429-remote.md | #42331 returned 404 despite being listed as the canonical representative; no mutation is safe against that unavailable ref. No cluster-wi... | [report](results/openclaw/gitcrawl-14088-dedupe-only-20260429-remote.md) | [27586018310](https://github.com/openclaw/clownfish/actions/runs/27586018310) |
| [ghcrawl-156979-autonomous-smoke](results/openclaw/ghcrawl-156979-autonomous-smoke.md) | needs human | jobs/openclaw/inbox/ghcrawl-156979-autonomous-smoke.md | #58173 live hydration returned HTTP 404/unavailable state, so this seed candidate cannot be classified or closed without a refreshed plan... | [report](results/openclaw/ghcrawl-156979-autonomous-smoke.md) | [27586017474](https://github.com/openclaw/clownfish/actions/runs/27586017474) |
| [ghcrawl-157011-autonomous-smoke](results/openclaw/ghcrawl-157011-autonomous-smoke.md) | needs human | jobs/openclaw/inbox/ghcrawl-157011-autonomous-smoke.md | Security-routed #39688 and #41375 block the cluster-level fix lane; central OpenClaw security handling must decide whether and how this h... | [report](results/openclaw/ghcrawl-157011-autonomous-smoke.md) | [27585541139](https://github.com/openclaw/clownfish/actions/runs/27585541139) |
| [ghcrawl-156978-autonomous-smoke](results/openclaw/ghcrawl-156978-autonomous-smoke.md) | needs human | jobs/openclaw/inbox/ghcrawl-156978-autonomous-smoke.md | Decide the safe implementation path for #38829 after routing security-sensitive PR #73402 to central OpenClaw security handling. | [report](results/openclaw/ghcrawl-156978-autonomous-smoke.md) | [27585540969](https://github.com/openclaw/clownfish/actions/runs/27585540969) |
| [ghcrawl-156857-autonomous-smoke](results/openclaw/ghcrawl-156857-autonomous-smoke.md) | fix blocked | jobs/openclaw/inbox/ghcrawl-156857-autonomous-smoke.md | fix artifact is too broad for autonomous execution; split into narrower jobs or explicitly set CLOWNFISH_ALLOW_BROAD_FIX_ARTIFACTS=1 | [report](results/openclaw/ghcrawl-156857-autonomous-smoke.md) | [27585280132](https://github.com/openclaw/clownfish/actions/runs/27585280132) |
| [ghcrawl-156620-autonomous-smoke](results/openclaw/ghcrawl-156620-autonomous-smoke.md) | needs human | jobs/openclaw/inbox/ghcrawl-156620-autonomous-smoke.md | Cluster-level fix lane requires maintainer or infrastructure follow-up because #25574 is validator-classified security-sensitive and the ... | [report](results/openclaw/ghcrawl-156620-autonomous-smoke.md) | [27585279455](https://github.com/openclaw/clownfish/actions/runs/27585279455) |
| [ghcrawl-156730-autonomous-smoke](results/openclaw/ghcrawl-156730-autonomous-smoke.md) | needs human | jobs/openclaw/inbox/ghcrawl-156730-autonomous-smoke.md | Central security triage must decide the fix path for the routed elevated/channel authorization work in #51245 and #53198 before Clownfish... | [report](results/openclaw/ghcrawl-156730-autonomous-smoke.md) | [27585279613](https://github.com/openclaw/clownfish/actions/runs/27585279613) |
| [ghcrawl-156716-autonomous-smoke](results/openclaw/ghcrawl-156716-autonomous-smoke.md) | needs human | jobs/openclaw/inbox/ghcrawl-156716-autonomous-smoke.md | #90305 is the exact unresolved decision: maintainer review is required before merge, and the worker cannot provide the required fresh Cod... | [report](results/openclaw/ghcrawl-156716-autonomous-smoke.md) | [27585279493](https://github.com/openclaw/clownfish/actions/runs/27585279493) |
| [gitcrawl-13587-dedupe-only-20260429-remote](results/openclaw/gitcrawl-13587-dedupe-only-20260429-remote.md) | needs human | jobs/openclaw/outbox/stuck/gitcrawl-13587-dedupe-only-20260429-remote.md | #49550 has unavailable live state from GitHub hydration: gh: Not Found (HTTP 404). | [report](results/openclaw/gitcrawl-13587-dedupe-only-20260429-remote.md) | [27585128483](https://github.com/openclaw/clownfish/actions/runs/27585128483) |
| [gitcrawl-13584-dedupe-only-20260429-remote](results/openclaw/gitcrawl-13584-dedupe-only-20260429-remote.md) | needs human | jobs/openclaw/outbox/stuck/gitcrawl-13584-dedupe-only-20260429-remote.md | No non-security canonical remains after validator-required route_security for #39688; maintainer/security handling should decide any cano... | [report](results/openclaw/gitcrawl-13584-dedupe-only-20260429-remote.md) | [27585129616](https://github.com/openclaw/clownfish/actions/runs/27585129616) |
| [gitcrawl-2612-dedupe-only-20260429-remote](results/openclaw/gitcrawl-2612-dedupe-only-20260429-remote.md) | needs human | jobs/openclaw/outbox/stuck/gitcrawl-2612-dedupe-only-20260429-remote.md | #50611 requires maintainer/product decision on the intended reserveTokensFloor clamp/default behavior after prior PR #50694 closed with f... | [report](results/openclaw/gitcrawl-2612-dedupe-only-20260429-remote.md) | [27585129387](https://github.com/openclaw/clownfish/actions/runs/27585129387) |
| [gitcrawl-2791-dedupe-only-20260429-remote](results/openclaw/gitcrawl-2791-dedupe-only-20260429-remote.md) | needs human | jobs/openclaw/outbox/stuck/gitcrawl-2791-dedupe-only-20260429-remote.md | #43661 needs maintainer/product direction for durable logical-send identity and retry semantics before a safe fix can be queued. | [report](results/openclaw/gitcrawl-2791-dedupe-only-20260429-remote.md) | [27585129035](https://github.com/openclaw/clownfish/actions/runs/27585129035) |
