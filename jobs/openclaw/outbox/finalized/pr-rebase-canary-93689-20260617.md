...
canonical_hint: "#93689 is the sole canonical PR. Rebase and validate the existing maintainer-editable branch before any separate merge finalization."
...
# Rebase-only repair canary: #93689

## Goal

Re-hydrate #93689. Because its base must match current main before finalization,
